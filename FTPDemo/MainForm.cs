...
namespace FTPDemo
{
    public partial class MainForm : Form
    {
        ...
        private void DownloadFile()
        {
            ...
            //MessageBox.Show(this.txtLocalPath.Text.Trim());
            //MessageBox.Show("2: "+this.lvServerFile.FocusedItem.SubItems[2].Text.ToString());
            //MessageBox.Show(this.lvServerFile.FocusedItem.SubItems[1].Text.ToString());
            //MessageBox.Show(this.lvServerFile.FocusedItem.SubItems[0].Text.ToString());
        }
        ...
        private void UploadFile()
        {
            ...
            try
            {
                ...
                //MessageBox.Show(relativePath+ "FTPDemo MainForm UploadFile()");
                this._begin = DateTime.Now;
        ...
        private void ShowFTPFileInfo(List<FtpFileModel> files)
        {
            ...
            if (files.Count != 0)
            {
                ...
                //MessageBox.Show(this.lvServerFile.Columns[1].Tag as string+ "1-当前相对路径父节点");    
